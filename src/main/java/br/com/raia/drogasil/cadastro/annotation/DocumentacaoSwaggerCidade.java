...
@ApiResponses(value = {
		...
		@ApiResponse(responseCode = "200", description = "Executado com sucesso",content = @Content(schema = @Schema(implementation = CidadeDTO.class))),
		@ApiResponse(responseCode = "201", description = "Criado com sucesso",content = @Content(schema = @Schema(implementation = CidadeDTO.class))),
...
public @interface DocumentacaoSwaggerCidade {
